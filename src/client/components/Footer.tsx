    ...
    return (
        <footer className={styles.footer}>
            <section className={styles.footer__top}>
                <div
                    className={`${styles.footer__topItem} ${styles.footer__logoBox}`}
                >
                    <img
                        className={`${styles.footer__logoImg} ${styles.header__logo}`}
                        src="/png/worldwide-white.png"
                        alt="bVote Logo"
                    />
                    <img
                        className={`${styles.footer__logoImg} ${styles.header__logo}`}
                ...
                <div
                    className={`${styles.footer__topItem} ${styles.footer__socials}`}
                >
                    <p className={styles.footer__socialsText}>
                        Follow our social media
                    </p>
                    <div className={styles.footer__socialsIcons}>
                        <Link
                            href="/telegram"
                            target="_blank"
                        ...
                        >
                            ...
                            >
                                <path
                                    className={styles.footer__socialsPath}
            ...
            <section className={styles.footer__bottom}>
                <div className={styles.footer__bottomList}>
                    <Link className={styles.footer__bottomItem} href="/">
                        Home page
                    </Link>
                    <Link className={styles.footer__bottomItem} href="/about">
                        What is bVote
                    </Link>
                    <Link
                        className={styles.footer__bottomItem}
                        href="/questions"
                    >
                        Questions and answers
                    </Link>
                    <Link className={styles.footer__bottomItem} href="/login">
                        Log in href your account
                    </Link>
                    <Link
                        className={styles.footer__bottomItem}
                        href="/documentation"
                    ...
                    <Link className={styles.footer__bottomItem} href="/signup">
                        Sign up
                    </Link>
                    <Link className={styles.footer__bottomItem} href="/about">
                        Personal data processing
                    </Link>
                    <Link className={styles.footer__bottomItem} href="/busines">
                        Adhesion agreement for partners
                    </Link>
                </div>
            </section>
        </footer>
