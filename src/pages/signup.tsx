'use client';
import styles from '../client/styles/signup.module.css';
import ReturnToHomeButton from '../client/components/ReturnToHomeButton';
import { useUser } from '../client/providers/UserProvider';
...
function Page() {
    ...
    function setServerPath() {
        if (process.env.NEXT_PUBLIC_DOMAIN && process.env.NEXT_PUBLIC_SERVER_PORT)
            return process.env.NEXT_PUBLIC_DOMAIN + process.env.NEXT_PUBLIC_SERVER_PORT;
        else
    ...
    async function onClick(event: React.MouseEvent<HTMLButtonElement>) {
        ...
        try {
            const res = await fetch(setServerPath() + '/create-user', {
                method: 'POST',
