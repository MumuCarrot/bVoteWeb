...
function Header() {
    ...
    return (
        <header onClick={setOverlayFalse}>
            ...
            <div className="HeaderMenu">
                ...
                <div className='user-profile-menu'>
                    ...
                    <Link to="#log-in" className='underline'>Log in</Link>
                </div>
            ...
            <div className="HeaderMain">
                <div className="PictureList">
                    <img className="PicturePadding" src="/worldwide.png" alt="Worldwide"/>
                    <img src="/logo.png" alt="bVote" />
                </div>
